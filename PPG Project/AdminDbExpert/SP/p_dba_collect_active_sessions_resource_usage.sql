USE [Admin]
GO
/****** Object:  StoredProcedure [dbo].[p_dba_collect_active_sessions_resource_usage]    Script Date: 12/15/2023 5:31:33 PM ******/
SET ANSI_NULLS ON
GO
...
-- =============================================
ALTER PROCEDURE [dbo].[p_dba_collect_active_sessions_resource_usage]
(
...
BEGIN
           ...
           ,[BlockedBySessionID],[GrantedQueryMemoryKB],[Cpu_Score],[WaitType],[Reads],[Writes],[LogicalReads],[PendingIOCount],[RowCount])
			...
			where 
				...
				AND ([Sessions].[login_name] like isnull('%'+@LOGIN_NAME+'%',[Sessions].[login_name]))
			order by Score desc
END
